...
O projeto utiliza a base pública Consumer Complaint Database do Consumer Financial Protection Bureau (CFPB).
...
O pipeline completo de NLP inclui:
...
Foi utilizada vetorização TF-IDF.
...
A base de dados contém apenas reclamações, portanto a análise de sentimento não poderia ser feita diretamente.
...
Baseline tradicional para TF-IDF.
...
O projeto inclui um dashboard em Streamlit para visualização dos resultados.
...
git clone https://github.com/cinthia-kobayashi/tech_challenge5.git
